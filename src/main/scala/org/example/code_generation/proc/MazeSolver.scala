...
*/
  ...
  def main(args: Array[String]): Unit = {
    ...
    Nat._1,
    M2._61,
    RightDownDirs,//Directions1,
    Arr30,//M2.filtered9.Out,//Arr30,
    PT[_0, _0] => PT[_29, _29],
    NoLoops with NoSubtyping
    ]
    for(e <- res2.expressions) {
      println(e.stringify("right"::"down"::HNil,//"up"::"down"::"left"::"right"::HNil,
        HListUtils.toHList(Range(0, 1000).map(_ => "").toList))(implicitly, null))
    }
  }
}
